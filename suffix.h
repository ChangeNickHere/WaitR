...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->suffixLabel->Location = System::Drawing::Point(73, 32);
			this->suffixLabel->Name = L"suffixLabel";
			this->suffixLabel->Size = System::Drawing::Size(277, 29);
			this->suffixLabel->TabIndex = 0;
			this->suffixLabel->Text = L"Please enter folder suffix";
			// 
			// textBox1
			// 
			...
			this->buttonContinue->Click += gcnew System::EventHandler(this, &suffix::buttonContinue_Click);
			// 
			// suffix
			// 
